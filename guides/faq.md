...
We have rough [milestones](../projects/1hive-updates.md) updated by individual swarms.
...
The common pool holds the Honey the DAO has available to use and can only be withdrawn from by passing Honey proposals. 
