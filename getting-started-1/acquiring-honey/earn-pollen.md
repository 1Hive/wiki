...
You also have to be [**Verified** ](../introduce-yourself/discord/#tips)in discord in order to receive weekly pollen distributions.
...
On Discord, in order to mint cred for other users through emoji responses, users giving the response must be [Verified](../introduce-yourself/discord/#tips). Minting to self is disabled and the system also weights the minting amount to others depending on how much cred the minter has earned.
